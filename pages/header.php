...
<nav class="navbar navbar-expand-lg navbar-dark bg-secondary sticky-top "  style="height: 80px; color:black" style="font-family: 'UTMSwissCondensed';">
       
        <div class="container p-0" height="50px" style="font-weight: bold; font-size:18px">
        <a id="tieude" class="navbar-brand pl-4" href="https://nentang.vn">ALS</a>
            ...
            <div class="collapse navbar-collapse" height="40px" width="100%" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <a class=" mr-3 dropdown-toggle" style="height: 42px;border:none;   margin-top: 7px; background:#6c757d;color:white"  type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Danh mục đèn
                    </a>
                    ...
                    <div class="dropdown nav-item active " >
                    <a class=" mr-2 dropdown-toggle" style="height: 42px;   margin-top: 7px; border:none;background:#6c757d; color:white;font: 18px; font-family:Arial, Helvetica, sans-serif"  type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Giá đèn
                    </a>
